     ...
     $.ajax({
               ...
               success: function(data) {
                    for (var i = 0; i < limit; i++) {
                         ...
                         function buildFeed(){
                              if(type === "image"){
                                   $(".tagged-feed").append("<div class='jgram-img'><a href='"+link+"' target='_blank'><img src=" + data.data[i].images.standard_resolution.url+ " /></a></div>");
                              }

                              if(type === "video"){
                                   $(".tagged-feed").append("<div class='jgram-img'><a href='"+link+"' target='_blank'><video controls><source src=" + data.data[i].videos.standard_resolution.url+ " ></video></a></div>");
                              }
                         }
